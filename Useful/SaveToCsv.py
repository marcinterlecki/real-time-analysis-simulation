...
if __name__ == "__main__":
    ...
    # Convert array column to string column
    parsed = parsed.withColumn("Decision", f.expr("array_join(Decision, ', ')"))

    # defining output
    def foreach_batch_function(df, epoch_id):
        df.write.format("csv").mode("append").save("output_directory", header=True)
